...
| [`lesson3`](lesson3/) ([how to run](lesson3/HOW_TO_RUN.md)) | Stop Embedding the Same Text Twice: Caching for Your RAG App | "Ask My Docs" with a vector cache and an answer cache, and a benchmark |
