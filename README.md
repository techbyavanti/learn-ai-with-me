...
| [`lesson2`](lesson2/) ([how to run](lesson2/HOW_TO_RUN.md)) | Your RAG App Works on Notes. Then You Give It a Real Document. | "Ask My Docs": chunking long documents, with an eval that compares four strategies |
